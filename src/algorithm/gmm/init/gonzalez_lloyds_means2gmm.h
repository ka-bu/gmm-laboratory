#ifndef GONZALEZ_LLOYDS_MEANS2GMM_H
#define GONZALEZ_LLOYDS_MEANS2GMM_H
...
namespace initializer
{
	 ...
	 */
	Parameters gonzalezLloydsMeans2GMM(commonutil::DataSet const& input, idx_type k, std::mt19937& gen, unsigned int substeps);
 ...
 */
class GonzalezLloydsMeans2GMMID : public InitDescription
{
public:
	const static std::string CLASSTAG;
	GonzalezLloydsMeans2GMMID(unsigned int substeps, uint32_t seed = 1);	
